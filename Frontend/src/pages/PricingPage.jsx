            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Create custom categories, tags, and locations. Organize items
                  by room, storage unit, or any custom system that works for
                  you.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Track item values, depreciation, and total home inventory
                  worth. Perfect for insurance purposes and financial planning.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="text-xl font-semibold mb-4 text-[#3BCD5B]">
                ...
                <p className="text-gray-600">
                  Store receipts, warranty cards, and important documents
                  alongside your items. Quick access when you need them most.
                </p>
              </div>
            </div>
          </div>
