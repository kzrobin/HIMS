...
const ProfileEdit = ({ onCancel }) => {
  ...
  const validateName = () => {
    if (formData.firstname.length < 2) {
      setNameError("First name should be at least two characters long");
      return false;
    }
    if (formData.lastname.length < 3) {
      setNameError("Last name should be at least three characters long");
      return false;
    }
